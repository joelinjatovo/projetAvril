...
{
    /**
     * The ThreadRepository class instance.
     *
     * @var \App\Repositories\ThreadRepository
     */
     ...
     *
     * @param \App\Repositories\ThreadRepository $conversation
     * @param \App\Repositories\MessageRepository           $message
     */
    public function __construct(ThreadRepository $conversation, MessageRepository $message)
    {
