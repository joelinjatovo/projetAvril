...
class ThreadRepository
{
    ...
    /*
     * check this given thread is exists
     *
     * @param   int $id
     * @return  bool
     * */
    ...
    {
        $conversation = Thread::where('user_one', $user1)
    ...
    {
        $exists = Thread::where('id', $conversationId)
    ...
    {
        return Thread::with(['messages' => function ($q) use ($offset, $take) {
