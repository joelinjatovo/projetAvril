        ...
        switch($user->role){
            case 'apl':
                return (new MailMessage)
                    ->from(env('ADMIN_MAIL'))
                    ->subject('New order that you are the selected APL')
            ...
            case 'afa':
                return (new MailMessage)
                    ->from(env('ADMIN_MAIL'))
                    ->subject('New order that you are the selected AFA')
                    ->greeting(sprintf('Hello %s', $user->name))
            ...
            case 'admin':
                if($cartItem){
                    ...
                    return (new MailMessage)
                        ...
                        ->subject('New order')
                        ->greeting(sprintf('Hello %s', $user->name))
                        ->line('A customer ordered products')
