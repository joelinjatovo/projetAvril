...
@section('content')
    <div class="row">
        <div class="col-md-4">
            @if($item->id>0)
            <a href="{{route('admin.state.create')}}" class="btn btn-primary btn-block margin-bottom">@lang('app.admin.state.create')</a>
            @endif
            <form role="form" method="post" action="{{$action}}" enctype="multipart/form-data">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                      @if($item->id>0)
                      <h3 class="box-title">@lang('app.admin.state.update')</h3>
                      @else
                      <h3 class="box-title">@lang('app.admin.state.create')</h3>
                      @endif
                      <div class="box-tools">
