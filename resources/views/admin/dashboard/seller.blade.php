            ...
            <div class="row-fluid">
                <div class="span6 widget widget-simple">
                    <div class="widget-header">
                        <h4><i class="fontello-icon-chart"></i>Repartition des sellers par Etats</h4>
                    </div>
                ...
                <div class="span6 widget well well-simple">
                    <div class="widget-header">
                        <h4><i class="fontello-icon-chart"></i>Repartition des sellers par date</h4>
                    </div>
                    <div class="widget-content">
                        <div class="widget-body">
...
function loadLocationData() {
    $.ajax({
        url: "{{route('chart.locations', array('type'=>'seller'))}}",
        ifModified:true,
...
function loadDateData() {
    $.ajax({
        url: "{{route('chart.dates', array('role'=>'seller'))}}",
        ifModified:true,
        success: function(content){
