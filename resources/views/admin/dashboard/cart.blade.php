            ...
            <div class="row-fluid">
                <div class="span6 widget widget-simple">
                    <div class="widget-header">
                        <h4><i class="fontello-icon-chart"></i>Repartition des utilisateurs par Etats</h4>
                    </div>
                ...
                <div class="span6 widget well well-simple">
                    <div class="widget-header">
                        <h4><i class="fontello-icon-chart"></i>Repartition des volumes de transactions par date</h4>
                    </div>
                    <div class="widget-content">
                        <div class="widget-body">
...
function loadLocationData() {
    $.ajax({
        url: "{{route('chart.locations', array('type'=>'user'))}}",
        ifModified:true,
...
function loadCartData() {
    $.ajax({
        url: "{{route('chart.carts')}}",
        ifModified:true,
        success: function(content){
            drawCartChart(content.data);
        }
    });
}
loadCartData();
