            ...
            <div class="row-fluid">
                <div class="span6 widget widget-simple">
                    <div class="widget-header">
                        <h4><i class="fontello-icon-chart"></i>Repartition des members par Etats</h4>
                    </div>
...
function loadLocationData() {
    $.ajax({
        url: "{{route('chart.locations', array('type'=>'member'))}}",
        ifModified:true,
...
function loadDateData() {
    $.ajax({
        url: "{{route('chart.dates', array('role'=>'member'))}}",
        ifModified:true,
        success: function(content){
