            ...
            <ul class="thumbnails equal-height">
                ...
                <li class="span3">
                    <div class="thumbnail bg-gray-light text-center">
                        <div class="equalize">
                            <div class="well well-nice"> <a href="#"><img class="radius3" src="{{url('/images/'.$item->title)}}" width="640" height="320"></a>
                            </div>
                        ...
                        <p class="action"> <a class="btn btn-small" href="{{ route('blog.update',$item->slug)}}"><i class="fontello-icon-edit"></i> Edit</a> 
